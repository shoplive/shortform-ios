...
#ifndef SHOPLIVESHORTFORMSDK_SWIFT_H
#define SHOPLIVESHORTFORMSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShopLiveShortformSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC20ShopLiveShortformSDK22AVAssetDownloadManager")
@interface AVAssetDownloadManager : NSObject
...
@interface AVAssetDownloadManager (SWIFT_EXTENSION(ShopLiveShortformSDK)) <AVAssetDownloadDelegate>
...
- (void)onShortsDetachedWithData:(ShopLiveShortformData * _Nonnull)data;
@end
...
@interface ShopLiveShortsCollectionView : UIView
